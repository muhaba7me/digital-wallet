...
export default function PaymentSuccess({
  ...
  return (
    <div className="w-full overflow-hidden flex flex-col px-4 py-4 h-full">
      <div className="flex-1 flex flex-col">
        ...
        <div className="mt-5 rounded-[2rem] p-6 shadow-sm">
      ...
      <div className="mt-4">
        <Button
          type="button"
          className="h-14 w-full rounded-full bg-linear-to-r from-primary via-primary/90 to-primary/80 hover:from-primary hover:via-primary/80 hover:to-primary/70 text-primary-foreground font-bold text-base shadow-xl hover:shadow-2xl transition-all"
          onClick={onDone}
        >
          Done
        </Button>
