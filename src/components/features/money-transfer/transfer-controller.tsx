...
import BankSelectionStep from "./components/bank-options";
import TransferMoneyStep from "./components/transfer-money";
import { STEPS } from "./step-config";

import type { TransferFormValues } from "./validation-schemas";
import ReceiverInfoStep from "./components/receiver-info";

import ConfirmOrderStep from "./components/confirm-order";

import PaymentSuccess from "./components/payment-success";
import ReceiverAccountStep from "./components/receiver-account";
...
import BankOptions from "./components/bank-options";
